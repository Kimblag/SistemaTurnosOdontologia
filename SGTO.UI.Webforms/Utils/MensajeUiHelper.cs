...
namespace SGTO.UI.Webforms.Utils
{
    public class MensajeUiHelper
    {
        ...
        {
            // acceder a la sesión activa mediando el contexto
        ...
        public static void MostrarModal(Page page)
        {
            ModalHelper.MostrarModalDesdeSession(page, SESSION_TITULO, SESSION_DESCRIPCION);
        }

        public static void SetearYMostrar(Page page, string titulo, string descripcion, string tipo = "Resultado")
        {
